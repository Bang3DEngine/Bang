...
template <class T>
void List<T>::Splice(typename List<T>::Iterator insertAfter, List<T> &from)
{
...
template <class T>
typename List<T>::Iterator List<T>::Insert(const typename List<T>::Iterator &it,
                                           const T &x)
{
...
template <class T>
typename List<T>::Iterator List<T>::Insert(const T &x, int index)
{
...
template <class T>
typename List<T>::Iterator List<T>::Remove(
    const typename List<T>::Iterator &first,
...
template <class T>
typename List<T>::Const_RIterator List<T>::REnd() const
{
    return m_list.crend();
}

template <class T>
typename List<T>::Const_RIterator List<T>::RBegin() const
{
    return m_list.crbegin();
}

template <class T>
typename List<T>::RIterator List<T>::REnd()
{
    return m_list.rend();
}

template <class T>
typename List<T>::RIterator List<T>::RBegin()
{

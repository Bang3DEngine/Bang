...
public:
    ...
    void create_textureFlat(unsigned int format,
                            unsigned int components,
                            const CTexture &baseImage);
    void create_texture3D(unsigned int format,
                          unsigned int components,
                          const CTexture &baseImage);
    ...
    void upload_texture2D(uint32_t imageIndex = 0,
...
private:
    ...
    unsigned int get_dword_aligned_linesize(unsigned int width,
                                            unsigned int bpp)
    {
